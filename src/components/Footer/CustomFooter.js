                ...
                <Container>
                    <Row >
                        <Col className='d-flex justify-content-end'>
                            <a href='https://www.linkedin.com/in/brendon-stahl-9a518a176/' rel="noreferrer" target="_blank" style={{textDecoration: "none"}}>
                                <div className='d-flex align-items-center justify-content-center socialBox'>
                                    <i className="fab fa-linkedin-in fa-3x d-sm-none"></i>
                                    <i className="fab fa-linkedin-in fa-4x d-none d-sm-block"></i>
                                </div>
                            </a>
                        </Col>
                        <Col className='d-flex justify-content-start'>
                            <a href='https://github.com/brendonstahl97' rel="noreferrer" target="_blank" style={{textDecoration: "none"}}>
                                <div className='d-flex align-items-center justify-content-center socialBox'>
                                    <i className="fab fa-github fa-3x d-sm-none"></i>
                                    <i className="fab fa-github fa-4x d-none d-sm-block"></i>
                                </div>
                            </a>
                        </Col>
                    </Row>
